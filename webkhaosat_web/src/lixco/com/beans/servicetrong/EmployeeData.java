...
public class EmployeeData {
	...
	private boolean female;// gioi tinh
	private String timeInEmp;
	private boolean quitEating;

	public EmployeeData(long id, String code, String codeOld, String name, String nameDepart, String codeDepart,
			String email, boolean layOff, boolean workShift, boolean female, String cateJobCode) {
		super();
		this.id = id;
		this.code = code;
	...
	public EmployeeData(long id, String code, String codeOld, String name, String codeDepart, String nameDepart,
			String timeInEmp, boolean quitEating) {
		this.id = id;
		this.code = code;
		this.codeOld = codeOld;
		this.name = name;
		this.codeDepart = codeDepart;
		this.nameDepart = nameDepart;
		this.timeInEmp = timeInEmp;
		this.quitEating = quitEating;
	}
	...
	public EmployeeData(long id, String code, String codeOld, String name, String nameDepart, String codeDepart,
			String email, boolean layOff, Date timeFixed, boolean workShift, Date dayAtWork, int numberDayOff,
			String cateJobCode) {
		this.id = id;
		this.code = code;
		this.codeOld = codeOld;
	...
	public String getTimeInEmp() {
		return timeInEmp;
	}

	public void setTimeInEmp(String timeInEmp) {
		this.timeInEmp = timeInEmp;
	}

	public boolean isQuitEating() {
		return quitEating;
	}

	public void setQuitEating(boolean quitEating) {
		this.quitEating = quitEating;
	}
